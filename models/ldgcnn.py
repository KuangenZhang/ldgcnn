...
def calc_ldgcnn_feature(point_cloud, is_training, bn_decay = None):
    ...
    net = tf.concat([point_cloud, net1], axis=-1) # linking features
    ...
    net = tf.concat([point_cloud, net1, net2], axis=-1) # linking features
    ...
    net = tf.concat([point_cloud, net1, net2, net3], axis=-1) # linking features
